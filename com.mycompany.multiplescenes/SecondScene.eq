...
{	
	...
	public void initialize(SEResourceCache rsc) {
		...
		mScene = add_sprite_for_color(Color.instance("white"),0.5*get_scene_width(),0.5*get_scene_height());
		mScene.move(0.5*get_scene_width(),0.5*get_scene_height());
		tScene = add_sprite_for_color(Color.instance("black"),0.5*get_scene_width(),0.125*get_scene_height());
		tScene.move(0.5*get_scene_width(),0.625*get_scene_height());
